...
indicesClaseN2=randperm(Lclass,LentrenamientoxClass);

%% SELECCIÓN Y EXTRACCIÓN DE LOS DATOS DE ENTRENAMIENTO:

DataEntreClaseN1=DataC1(1:4,indicesClaseN1);
DataEntreClaseN2=DataC2(1:4,indicesClaseN2);

%% ORGANIZACIÓN DEL VECTOR DE ENTRENAMIENTO DE LA RED NEURONAL:


DataTrain=[DataEntreClaseN1,DataEntreClaseN2];

EtiquetasEntre=[DataC1(5,indicesClaseN1),DataC2(5,indicesClaseN2)];
...
dataValC2=DataC2(1:4,indxValC2);
...
dataEtiValC2=DataC2(5,indxValC2);
